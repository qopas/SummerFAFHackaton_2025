...
public class UpdateProjectVisibilityCommandHandler(
    IProjectRepository projectRepository,
    ICurrentUserService currentUserService)
    : IRequestHandler<UpdateProjectVisibilityCommand, Result<ProjectDto>>
{
    public async Task<Result<ProjectDto>> Handle(UpdateProjectVisibilityCommand request, CancellationToken cancellationToken)
    {
        ...
        if (!isOwner)
            throw new UnauthorizedAccessException("Only the project creator can update the project visibility");
