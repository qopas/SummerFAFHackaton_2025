...
{
    /// <inheritdoc />
    public partial class grigoras_added_team_table : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TeamLead = table.Column<string>(type: "character varying(36)", maxLength: 36, nullable: true),
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "admin-role-id", "5fd06d3b-b0d5-43f2-9757-0a61b20a7c68", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Administrator with full access", "Admin", "ADMIN" },
                    { "creator-role-id", "d792dfa9-83d8-4244-a216-c56305bd2bac", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Content creator with special permissions", "Creator", "CREATOR" },
                    { "user-role-id", "ea06de4e-6dba-4fd1-9911-b9adfa996a29", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Regular user with limited access", "User", "USER" }
                });
