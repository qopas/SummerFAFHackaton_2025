...
namespace Ediki.Infrastructure.Migrations
{
    ...
    [Migration("20250622053014_AddTeamInvitationNotificationType")]
    partial class AddTeamInvitationNotificationType
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ediki.Domain.Entities.DemoAction", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(50)
                    ...
                    b.Property<TimeSpan>("TimestampInSession")
                    ...
                    b.HasIndex("TimestampInSession");

                    b.HasIndex("UserId");

                    b.ToTable("DemoActions");
                });

            modelBuilder.Entity("Ediki.Domain.Entities.DemoMessage", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");
            ...
            modelBuilder.Entity("Ediki.Domain.Entities.DemoParticipant", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");

                    b.Property<bool>("CanInteract")
                        .HasColumnType("boolean");
                    ...
                    b.HasIndex("DemoSessionId", "UserId")
                        .IsUnique();

                    b.ToTable("DemoParticipants");
                });

            modelBuilder.Entity("Ediki.Domain.Entities.DemoRecording", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");
            ...
            modelBuilder.Entity("Ediki.Domain.Entities.DemoSession", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");
            ...
            modelBuilder.Entity("Ediki.Domain.Entities.Notification", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(36)
            ...
            modelBuilder.Entity("Ediki.Domain.Entities.ProjectMember", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Ediki.Domain.Entities.DemoAction", b =>
                {
                    b.HasOne("Ediki.Domain.Entities.DemoSession", "DemoSession")
                        .WithMany("Actions")
                        .HasForeignKey("DemoSessionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Ediki.Domain.Entities.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Ediki.Domain.Entities.DemoSession", b =>
                {
                    b.HasOne("Ediki.Domain.Entities.ApplicationUser", "Host")
                        .WithMany()
                        .HasForeignKey("HostUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.OwnsOne("Ediki.Domain.Entities.DemoSettings", "Settings", b1 =>
                        {
                            b1.Property<string>("DemoSessionId")
                                .HasColumnType("character varying(50)");

                            b1.Property<bool>("AllowChat")
                                .HasColumnType("boolean");

                            b1.Property<bool>("AllowQuestions")
                                .HasColumnType("boolean");
                            ...
                            b1.Property<bool>("AutoRecord")
                                .HasColumnType("boolean");

                            b1.Property<int>("RecordingQuality")
                                .HasColumnType("integer");

                            b1.Property<bool>("RequireApproval")
                                .HasColumnType("boolean");

                            b1.HasKey("DemoSessionId");

                            b1.ToTable("DemoSessions");
            ...
            modelBuilder.Entity("Ediki.Domain.Entities.ProjectMember", b =>
                {
                    b.HasOne("Ediki.Domain.Entities.ApplicationUser", "InvitedByUser")
                        .WithMany()
